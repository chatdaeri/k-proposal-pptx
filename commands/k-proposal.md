---
name: k-proposal
description: 한국식 제안서 PPT 생성 (12~18장 자동 구성). 사용자 브리프나 inputs/ 파일을 받아 CHATdaeri 오렌지 브랜드 23개 템플릿으로 .pptx를 빌드합니다. "제안서 만들어줘", "한국식 PPT", "맥킨지 스타일", "k-제안서", "k-ppt" 등의 자연어로도 트리거됩니다.
---
